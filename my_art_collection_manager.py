class ArtGallery:
    ...
    def __init__(self, gallery_name, location):
        ...
        print(f"Gallery location: {self.location}")
    ...
    def remove_artwork(self, artwork):
        if artwork in self.artworks:
            ...
            print(f"'{artwork}' was not found in the art collection.")
    ...
    def __del__(self):
        print(f"{self.gallery_name} is now closing, Thank you for closing the art collection!")

gallery = ArtGallery("Rocky Gallery", "Georgia")
...
while True:
    ...
    if choice == "1":
        artwork_name = input("Enter the art piece name to add: ")
        gallery.add_artwork(artwork_name)

    elif choice == "2":
        artwork_name = input("Enter the art piece name to remove: ")
        ...
        print("Now exiting the Art Collection Manager.")

        del gallery
        break

    else:
        print("The answer you provided is not an option, please enter a number from 1 to 4.")
